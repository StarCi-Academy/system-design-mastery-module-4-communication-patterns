/**
 * Khởi tạo Nest app Product Service — ValidationPipe toàn cục và lắng nghe cổng.
 * (EN: Bootstrap Nest Product Service app — global ValidationPipe and listen on port.)
 */
import {
    ValidationPipe,
} from "@nestjs/common"
