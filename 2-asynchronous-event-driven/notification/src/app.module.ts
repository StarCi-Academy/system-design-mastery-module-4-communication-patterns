...
/**
 * Module gốc Notification — đăng ký controller và service cho Kafka consumer.
 * (EN: Root Notification module — registers controller and service for Kafka consumer.)
 */
import {
    Module,
} from "@nestjs/common"
