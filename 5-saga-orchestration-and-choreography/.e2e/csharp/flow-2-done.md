# C# — Flow 2: kiem chung kho da bi tru
...
PASS — buoc inventory da commit local transaction tren MongoDB (decrement stock 50->49 + luu fulfillment). Goi lai don da xong tra `ALREADY_FULFILLED` (StockService tim thay fulfillment cu) thay vi tru kho lan hai — fulfillments la khoa idempotent.
