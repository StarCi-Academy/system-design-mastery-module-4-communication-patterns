# C# — Flow 5: quan sat chuoi event tren Kafka UI / topic saga.demo.events

Kafka UI (http://localhost:8081) soi topic `saga.demo.events`. Doc truc tiep topic + consumer group qua broker.
