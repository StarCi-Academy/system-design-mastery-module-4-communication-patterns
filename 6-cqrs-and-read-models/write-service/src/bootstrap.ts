/**
 * Khởi tạo Nest app — CQRS Write Service (Command side).
 * Nhận command POST, lưu vào PostgreSQL (Write Model), emit event qua RabbitMQ.
 * (EN: Bootstrap Nest app — CQRS Write Service (Command side).
 * Receives POST commands, persists to PostgreSQL (Write Model), emits events via RabbitMQ.)
 */
import {
    NestFactory,
} from "@nestjs/core"
